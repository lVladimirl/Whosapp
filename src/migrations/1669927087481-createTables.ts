...
export class createTables1669927087481 implements MigrationInterface {
    name = 'createTables1669927087481'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(2000) NOT NULL, "email" character varying array NOT NULL, "telefone" character varying array NOT NULL, "criadoEm" TIMESTAMP NOT NULL, "userId" uuid, CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
